...
export function TeacherDashboard({ teacherName, teacherSubject, onLogout }: TeacherDashboardProps) {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "dashboard":
        return <TeacherDashboardHome teacherName={teacherName} teacherSubject={teacherSubject} onNavigate={setActiveTab} />;
      case "assignments":
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <button
              ...
              className="lg:hidden p-2 hover:bg-red-200 rounded-xl transition-colors"
            >
