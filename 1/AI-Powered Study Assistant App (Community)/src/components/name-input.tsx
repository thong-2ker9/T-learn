    ...
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <Card className="relative z-10 w-full max-w-md p-8 bg-white/95 backdrop-blur-md shadow-2xl border-2 border-red-200">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-red-600 mb-2">Chào mừng!</h1>
          <p className="text-gray-600">Hãy cho chúng tôi biết tên của bạn để bắt đầu hành trình học tập cùng StudyAI</p>
        </div>
